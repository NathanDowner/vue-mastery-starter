...
Vue.component('product-detail-tabs', {
    ...
    template: `
        <div>
            ...
            <p v-show="selectedTab !== 'Details'">Shipping: {{ shipping }}</p>
        </div>
    `,
    data() {
        return {
    ...
    template: `
        <div>
            ...
            <div v-show="selectedTab === 'Reviews'">
                ...
                <ul v-else>
                    <li v-for="(review, i) in reviews" v-bind:key="i">
                        <p>{{ review.name }}</p>
                        <p>{{ review.review }}</p>
                        <p>{{ review.rating }}</p>
                    </li>
            ...
            variants: [
                {
                    id: 23,
                    color: 'green',
                    img: './images/vmSocks-green-onWhite.jpg',
                    qty: 10
                },
                {
                    variantId: 24,
                    color: 'blue',
                    img: './images/vmSocks-blue-onWhite.jpg',
                    qty: 0
                },
            ],
            reviews: []
